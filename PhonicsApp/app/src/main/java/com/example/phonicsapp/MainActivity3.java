...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, " onCreate Activity Main 3 i.e. Learning App module");
    ...
    protected void onStart(){
        super.onStart();
        Log.d(TAG, " onStart Activity Main 3 i.e. Learning App module");
    }
    ...
    protected void onResume(){
        super.onResume();
        Log.d(TAG, " onResume Activity Main 3 i.e. Learning App module");
    }
    ...
    protected void onPause(){
        super.onPause();
        Log.d(TAG, " onPause Activity Main 3 i.e. Learning App module");
    }
    ...
    protected void onStop(){
        super.onStop();
        Log.d(TAG, " onStop Activity Main 3 i.e. Learning App module");
    }
    ...
    protected void onDestroy(){
        super.onDestroy();
        Log.d(TAG, " onDestroy Activity Main 3 i.e. Learning App module");
    }
    ...
    protected void onRestart(){
        super.onRestart();
        Log.d(TAG, " onRestart Activity Main 3 i.e. Learning App module");
    }
}